...
# Load the dataset
healthcare = pd.read_csv("D:\\DataCamp\\Datasets\\insuriii.csv")
...
plt.figure(figsize=(10, 6))
sns.boxplot(x='region', y='charges', data=healthcare, palette='Set2')
...
plt.figure(figsize=(10, 6))
sns.barplot(x='age_group', y='charges', data=healthcare, estimator=lambda x: sum(x) / len(x), palette='Set2')
